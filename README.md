...
Web Application
A simple Streamlit application is included to make the analysis interactive.
The dashboard allows users to:
View the main charts generated in the project
Explore each player’s shooting and heading statistics
Inspect raw data and summary metrics
Interactively compare players
